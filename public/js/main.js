...
//  этот код не верный,но нужен
// class Item { // класс одного товара
//     product_name = '';   //предварительно объявляем свойства
//     price = 0;
//     id_product = 0;
//     img = '';
//     rendered = false;
//
//     constructor(product, img = 'https://placehold.it/200x150') {  // присваеваем через конструктов свойства, (откуда что брать)
//         ({product_name: this.product_name, price: this.price, id_product: this.id_product} = product);
//         this.img = img;
//
//     }
...
//     render(){
//       this.rendered = true;
//       return `<div className="cart-item" data-id="${this.id_product}">
//           <div className="product-bio">
//               <img src="${this.img}" alt="Some image">
//                   <div className="product-desc">
//                       <p className="product-title">${this.product_name}</p>
//                       <p className="product-quantity">Quantity: ${this.quantity}</p>
//                       <p className="product-single-price">$${this.price} each</p>
//                   </div>
//           </div>
//           <div className="right-block">
//               <p className="product-price">$${this.quantity * this.price}</p>
//               <button className="del-btn" data-id="${this.id_product}">&times;</button>
//           </div>
//       </div>`
//     }
//
...
//
//     constructor(selector, url) {
//         this.container = document.querySelector(selector); // свойства классов
//         this.url = url;
//         this._init();
//     }
//
...
//     handeleData(data){
//         for (let item of data){
//             this.products.push(new List.itemMap[this.constructor.name](item))
//         }
//         this._render();
//
//     }
...
//
//
// class Products extends List {  // основной класс
//     cart = null;
//
